...
public class OfficeController {
  ...
  public ResponseEntity<Page<OfficeResponseDto>> findAllOffices(
    ...
    Page<OfficeResponseDto> officesPage =
        officeService.findAllOffices(name, number, page, pageSize);
  ...
  @PostMapping()
  public ResponseEntity<OfficeResponseDto> saveOffice(
      @RequestBody @Valid OfficeRequestDto officeRequestDto) {
  ...
  public ResponseEntity<OfficeResponseDto> updateOffice(
      @RequestBody @Valid OfficeRequestDto officeRequestDto, @PathVariable("id") Long id) {
