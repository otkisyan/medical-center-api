...
public final class AppointmentController {
  ...
  public ResponseEntity<ConsultationResponseDto> getAppointmentConsultation(
      @PathVariable("id") Long appointmentId) {
    ConsultationResponseDto consultationResponseDto =
        appointmentService.getAppointmentConsultation(appointmentId);
  ...
  public @ResponseBody ResponseEntity<AppointmentResponseDto> saveAppointment(
    ...
    URI location =
        ServletUriComponentsBuilder.fromCurrentRequest()
            ...
            .toUri();
    return ResponseEntity.created(location).body(appointmentResponseDto);
  }

  @PutMapping("/{id}")
  public ResponseEntity<AppointmentResponseDto> updateAppointment(
      @RequestBody AppointmentRequestDto appointmentRequestDto, @PathVariable("id") Long id) {
    AppointmentResponseDto appointmentResponseDto =
