...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ValidationErrorResponse> handleTenantException(
  ...
  public ResponseEntity<ErrorResponse> handleUserPasswordChangeException(
      UserPasswordChangeException ex, HttpServletRequest request) {
    return buildErrorResponse(ex.getMessage(), HttpStatus.BAD_REQUEST, request);
  }

  @ExceptionHandler(AppointmentDoctorConflictException.class)
  public ResponseEntity<ErrorResponse> handleAppointmentDoctorConflictException(
      AppointmentDoctorConflictException ex, HttpServletRequest request) {
    return buildErrorResponse(ex.getMessage(), HttpStatus.CONFLICT, request);
  }

  @ExceptionHandler(AppointmentPatientConflictException.class)
  public ResponseEntity<ErrorResponse> handleAppointmentPatientConflictException(
      AppointmentPatientConflictException ex, HttpServletRequest request) {
    return buildErrorResponse(ex.getMessage(), HttpStatus.CONFLICT, request);
  }

  @ExceptionHandler(InvalidAppointmentTimeException.class)
  public ResponseEntity<ErrorResponse> handleInvalidAppointmentTimeException(
      InvalidAppointmentTimeException ex, HttpServletRequest request) {
    return buildErrorResponse(ex.getMessage(), HttpStatus.BAD_REQUEST, request);
  }
  ...
  public ResponseEntity<ErrorResponse> handleWorkScheduleDoesNotExistException(
      WorkScheduleDoesNotExistException ex, HttpServletRequest request) {
    return buildErrorResponse(ex.getMessage(), HttpStatus.NOT_FOUND, request);
  }
  ...
  public ResponseEntity<ErrorResponse> handleInvalidTokenTypeException(
      InvalidTokenTypeException ex, HttpServletRequest request) {
    return buildErrorResponse(ex.getMessage(), HttpStatus.UNAUTHORIZED, request);
  }
